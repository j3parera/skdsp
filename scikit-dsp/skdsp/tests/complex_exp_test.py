...
class ComplexExponentialTest(unittest.TestCase):

    def test_constructor(self):
        c = ComplexExponential()
        ...
        c1 = ComplexExponential(3, sp.S.Pi/4, sp.S.Pi/6)
        c2 = 3*ComplexExponential().delay(-sp.S.Pi/6).scale(sp.S.Pi/4)
    ...
    def test_eval_range(self):
        ...
        phi0s = sp.S.Pi/6
        phi0n = np.pi/6
        c = ComplexExponential(1, omega0s, phi0s)
        n = np.arange(0, 2)
    ...
    def test_dtype(self):
        c = ComplexExponential(1, sp.S.Pi/4, sp.S.Pi/6)
    ...
    def test_frequency(self):
        ...
        c = ComplexExponential(1, sp.S.Pi/4, sp.S.Pi)
        self.assertEqual(c.phase_offset, -sp.S.Pi)
        c = ComplexExponential(1, sp.S.Pi/4, 1/2)
        self.assertEqual(c.phase_offset, 1/2)
        c = ComplexExponential(1, sp.S.Pi/4, 2*sp.S.Pi)
        self.assertEqual(c.phase_offset, 0)
        c = ComplexExponential(1, sp.S.Pi/4, 3*sp.S.Pi)
        self.assertEqual(c.phase_offset, -sp.S.Pi)
